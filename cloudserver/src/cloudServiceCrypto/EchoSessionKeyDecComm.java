 ...
 * @author Mark Case
 */
public class EchoSessionKeyDecComm {

    public static byte[] decrypt(String ct, String IV, String uName, String sName, byte[] sessKey, byte[] nonce) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException {
        //String masterPass = "";
        ...
        try {
            ...
            Logger.getLogger(EchoSessionKeyDecComm.class.getName()).log(Level.SEVERE, null, ex);
        }
