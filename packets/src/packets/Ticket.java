...
public class Ticket implements Packet, JSONSerializable {
     ...
     * @param eSKey 
     */
    public Ticket(long createTime, long validityTime, String uName, String sName, String iv, String eSKey) {
     ...
     */
    public Ticket(String packet, PacketType packetType) throws InvalidObjectException {
        recieve(packet);
    }
