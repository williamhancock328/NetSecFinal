 ...
 * @author Mark Case
 */
public class KeyWordRequest implements Packet, JSONSerializable {

    // Packet Type
    private static final PacketType PACKET_TYPE = PacketType.KeyWordRequest;
     ...
     * JSONObject
     */
    public KeyWordRequest(String packet, PacketType packetType1) throws InvalidObjectException {
        recieve(packet);
    }
    ...
    public void deserialize(JSONType obj) throws InvalidObjectException {
        ...
        if (obj instanceof JSONObject) {
            ...
            if (tmp.containsKey("keyWords")) {
                ...
                throw new InvalidObjectException("Expected a toString of ArrayList keyWords object -- keywords expected.");
            }
