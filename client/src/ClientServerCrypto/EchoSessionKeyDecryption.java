...
public class EchoSessionKeyDecryption {
    ...
    public static byte[] decrypt(String ct, String IV, String uName, byte[] sessKey, String serviceName, byte[] nonce) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException {
        //String masterPass = "";
