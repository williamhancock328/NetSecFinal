...
public class EchoSessionKeyEncryption {
    ...
    public static byte[] encrypt(byte[] sessKey, String ctext, String uName, String sName, byte[] nonce) throws
        ...
        byte[] ciphertext = aesCipher.doFinal(ctext.getBytes(StandardCharsets.UTF_8));
        return ciphertext;
